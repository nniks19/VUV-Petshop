<?php
    ...
    $artikli_od_brenda = explode(",",get_post_meta(get_queried_object_id(), 'artikli_od_brenda', true));
    $args = array( 'post__in' => $artikli_od_brenda, 'post_type' =>  'artikl', 'post_status' => 'publish', 'post_per_page' => 50); 
